...
$$COR\,=\,\sum_{w}\,\left[\frac{\frac{\sum_{y}\,P(Y=y\mid A=1,W=w)}{(1\,-\,\sum_{y}\,P(Y=y\mid A=1,W=w))}}{\frac{\sum_{y}\,P(Y = y\mid A=0,W=w)}{(1\,-\,\sum_{y}\,P(Y = y\mid A=0,W=w))}}\right]\text{P(W=w)},$$ where $P(W=w)$ refers to the marginal probability of w.
