...
Our simulations contain 4 different cases. The probability of dying after one year with dual therapy varies between 4% and 27%, and the probability of dying after one year with single therapy is about 33%. These numbers are meaningful in our example and based on real-world colorectal cancer estimates. Depending on the setting, the relevant relative risks and odds are “normal” or “extreme”. No matter what numbers are chosen, bias due to effect modification and collapsibility persist. The interested reader is welcome to modify our simulation (see [here](https://github.com/migariane/hetmor/blob/master/MonteCarloSimulation.r)) and explore the level of bias relative to the extent of effect modification.
